...
class TrafficServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetTrafficStatus = channel.unary_unary(
                '/grpc_services.TrafficService/GetTrafficStatus',
...
def add_TrafficServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'grpc_services.TrafficService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('grpc_services.TrafficService', rpc_method_handlers)
